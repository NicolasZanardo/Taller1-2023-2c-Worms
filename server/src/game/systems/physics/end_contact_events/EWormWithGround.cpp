#include "EWormWithGround.h"
#include "../../../model/worm/Worm.h"
#include <iostream>

bool EWormWithGround::try_resolve(b2Fixture *fixtureA, b2Fixture *fixtureB) {
...
EWormWithGround::EWormWithGround(b2World &world) : CollisionEvent(world) {}
